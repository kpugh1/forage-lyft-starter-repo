...
class TestGlissade(unittest.TestCase):
    ...
    def test_engine_should_be_serviced(self):
        ...
        car = CarFactory.create_glissade(NULL,last_service_date, current_mileage, last_service_mileage)
        self.assertTrue(car.needs_service())
...
class TestPalindrome(unittest.TestCase):
    ...
    def test_engine_should_be_serviced(self):
        ...
        car = CarFactory.create_palindrome(NULL, last_service_date, warning_light_is_on)
        self.assertTrue(car.needs_service())
...
class TestRorschach(unittest.TestCase):
    ...
    def test_engine_should_be_serviced(self):
        ...
        car = CarFactory.create_rorschach(NULL, last_service_date, current_mileage, last_service_mileage)
        self.assertTrue(car.needs_service())
...
class TestThovex(unittest.TestCase):
    ...
    def test_engine_should_be_serviced(self):
        ...
        car = CarFactory.create_thovex(NULL, last_service_date, current_mileage, last_service_mileage)
        self.assertTrue(car.needs_service())
